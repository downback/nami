    ...
    <BlackWrapper>
      <div className={styles.CopyrightContainer}>
        ...
        <p>
          ...
          of Henam Shin. The use of the Internet pages of Henam Shin is possible
        ...
        <p>
          ...
          applicable to Henam Shin. By means of this data protection
        ...
        <p>
          As the controller, Henam Shin has implemented numerous technical and
        ...
        <ul>
          <li>
            <h4 className={styles.TitleText}>a&#41; Personal data</h4>
            <p>
          ...
          <li>
            <h4 className={styles.TitleText}>b&#41; Data subject</h4>
            <p>
          ...
          <li>
            <h4 className={styles.TitleText}>c&#41; Processing</h4>
            <p>
          ...
          <li>
            <h4 className={styles.TitleText}>e&#41; Profiling</h4>
            <p>
          ...
          <li>
            <h4 className={styles.TitleText}>f&#41; Pseudonymisation</h4>
            <p>
          ...
          <li>
            <h4 className={styles.TitleText}>h&#41; Processor</h4>
            <p>
          ...
          <li>
            <h4 className={styles.TitleText}>i&#41; Recipient</h4>
            <p>
          ...
          <li>
            <h4 className={styles.TitleText}>j&#41; Third party</h4>
            <p>
          ...
          <li>
            <h4 className={styles.TitleText}>k&#41; Consent</h4>
            <p>
        ...
        <p>
          ...
          &#40;GDPR&#41;, other data protection laws applicable in Member states
          of the European Union and other provisions related to data protection
          is:
        </p>
        <p>Henam Shin</p>
        <p>Mariannenstr. 27</p>
        ...
        <p>
          The website of Henam Shin collects a series of general data and
          ...
          used, &#40;2&#41; the operating system used by the accessing system,
          &#40;3&#41; the website from which an accessing system reaches our
        ...
        <p>
          When using these general data and information, Henam Shin does not
          draw any conclusions about the data subject. Rather, this information
          is needed to &#40;1&#41; deliver the content of our website correctly,
          &#40;2&#41; optimize the content of our website as well as its
          ...
          criminal prosecution in case of a cyber-attack. Therefore, Henam Shin
        ...
        <p>
          The website of Henam Shin contains information that enables a quick
          ...
          electronic mail &#40;e-mail address&#41;. If a data subject contacts
        ...
        <ul>
          <li>
            <h4 className={styles.TitleText}>a&#41; Right of confirmation</h4>
            <p>
          ...
          <li>
            <h4 className={styles.TitleText}>b&#41; Right of access</h4>
            <p>
              Each data subject shall have the right granted by the European
          ...
          <li>
            <h4 className={styles.TitleText}>c&#41; Right to rectification </h4>
            <p>
              Each data subject shall have the right granted by the European
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                based according to point &#40;a&#41; of Article 6&#40;1&#41; of
              ...
              <li>
                ...
                of information society services referred to in Article
                8&#40;1&#41; of the GDPR.
              </li>
            </ul>
            <p>
              If one of the aforementioned reasons applies, and a data subject
              wishes to request the erasure of personal data stored by Henam
              Shin, he or she may, at any time, contact any employee of the
              controller. An employee of Henam Shin shall promptly ensure that
            ...
            <p>
              ...
              far as processing is not required. An employees of the Henam Shin
          ...
          <li>
            ...
            <p>
              ...
              data stored by Henam Shin, he or she may at any time contact any
              employee of the controller. The employee of Henam Shin will
          ...
          <li>
            ...
            <p>
              ...
              long as the processing is based on consent pursuant to point
              &#40;a&#41; of Article 6&#40;1&#41; of the GDPR or point
              &#40;a&#41; of Article 9&#40;2&#41; of the GDPR, or on a contract
            ...
            <p>
              ...
              from one controller to another, where technically feasible and
            ...
            <p>
              ...
              may at any time contact any employee of Henam Shin.
            </p>
          </li>
          <li>
            <h4 className={styles.TitleText}>g&#41; Right to object</h4>
            <p>
              Each data subject shall have the right granted by the European
              ...
              Article 6&#40;1&#41; of the GDPR. This also applies to profiling
              based on these provisions.
            </p>
            <p>
              Henam Shin shall no longer process the personal data in the event
            ...
            <p>
              If Henam Shin processes personal data for direct marketing
              ...
              Henam Shin to the processing for direct marketing purposes, Henam
              Shin will no longer process the personal data for these purposes.
            </p>
            <p>
              ...
              personal data concerning him or her by Henam Shin for scientific
            ...
            <p>
              ...
              contact any employee of Henam Shin. In addition, the data subject
              is free in the context of the use of information society services,
          ...
          <li>
            ...
            <p>
              ...
              explicit consent, Henam Shin shall implement suitable measures to
            ...
            <p>
              ...
              contact any employee of the Henam Shin.
            </p>
          </li>
          <li>
            <h4 className={styles.TitleText}>
            ...
            <p>
              ...
              consent, he or she may, at any time, contact any employee of Henam
              Shin.
            </p>
          </li>
        </ul>
        ...
        <p>
          ...
          data subject or of another natural person. This would be the case, for
        ...
        <p>
          ...
          <a className={styles.LinkText} href="https://willing-able.com/">
            LegalTech
          </a>{" "}
          at Willing &amp; Able that also developed the system for{" "}
          <a className={styles.LinkText} href="https://abletotrack.com/">
            work hours tracker
          </a>
          . The legal texts contained in our privacy policy generator have been
          provided and published by{" "}
          <a className={styles.LinkText} href="https://dg-datenschutz.de/">
